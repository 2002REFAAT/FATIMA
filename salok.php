...
<head>
	...
	<title>Clients</title>
    <link rel="stylesheet" href="bienvenu.css">
...
<center class="bienvenue"><h1><marquee behavior="alternate" style="border:solid 1.5px;border-radius: 17px;">Bienvenue sur note site - Gestion Commerciale</marquee></h1></center>
  ...
  <form method="POST" action="#">
   ...
   <center> <button type="submit" name="salima"  ><b>creer une compt</b></button></center>
  </form>
</div>
<script src='http://localhost/page/creeruncompt.php'></script>

     <?php   

if(isset($_POST['salima'])) {
